    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (carts != null) {
            ...
            for (Map.Entry<Integer, Cart> entry : carts.entrySet()) {
                Integer key = entry.getKey();
                Cart valuecart = entry.getValue();
                productdb.UpdateSetQuantity(valuecart.getProduct().getId(), (valuecart.getProduct().getQuantity() - valuecart.getQuantity()));
                System.out.println(valuecart.getProduct().getQuantity());
                System.out.println(valuecart.getProduct().getId());
                System.out.println(valuecart.getQuantity());
                System.out.println(valuecart.getProduct().getQuantity() - valuecart.getQuantity());
            }
